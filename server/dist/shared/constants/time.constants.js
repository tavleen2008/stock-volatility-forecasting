...
exports.getRangeParams = exports.mapDaysToRange = exports.TIME_RANGES = void 0;
exports.TIME_RANGES = ['1d', '5d', '1mo', '3mo', '1y'];
// Helper to safely convert an integer number of days to our frontend-friendly TimeRange strings
const mapDaysToRange = (days) => {
    if (days <= 5)
        return '5d';
    if (days <= 30)
        return '1mo';
...
exports.mapDaysToRange = mapDaysToRange;
...
exports.getRangeParams = getRangeParams;
